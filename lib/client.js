...
// AwaitingConfirm
// AwaitingWithBuffer
// 在收到当前 operation 的 Ack 之前不会发送下一个 operation

// 版本管理：
// 1. 客户端进行一次编辑产生一个 operation 或者从服务端接收到一个 operation，客户端版本号都会递增一
// 2. 服务端作为客户端并发编辑操作串行化的地点，除了保存文档内容，还会将客户端发过来的 operation 保存到一个数组中，这个数组也就是文档编辑的历史记录。服务端每接收到一个操作，服务端版本号会递增一
// 3. 客户端版本号始终小于等于服务端版本号
